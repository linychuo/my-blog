---
title: "AI Agent Skills 术语详解：2025-2026 完整指南（图解版）"
date_time: 2026-03-08 18:00:00
tags: AI Agent Skills MCP LLM 人工智能
---

# AI Agent Skills 术语详解：2025-2026 完整指南（图解版）
...
```
用户 → AI Agent → 大语言模型 → Function Calling → 工具集
                    ↓
                记忆系统
                    ├─ 短期记忆（当前会话）
                    └─ 长期记忆（跨会话持久化）

工具集包括：Skills、MCP Protocol、外部 API
```

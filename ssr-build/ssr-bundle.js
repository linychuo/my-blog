...
var createBrowserHistory_createBrowserHistory = function createBrowserHistory() {
  ...
  var push = function push(path, state) {
    warning_default()(!((typeof path === 'undefined' ? 'undefined' : _typeof(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
  ...
  var replace = function replace(path, state) {
    warning_default()(!((typeof path === 'undefined' ? 'undefined' : _typeof(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
...
var Route_Route = function (_React$Component) {
  ...
  Route.prototype.render = function render() {
    ...
    match ? preact_compat_es.createElement(component, props) : null : render ? // render prop is next, only called if there's a match
    match ? render(props) : null : children ? // children come last, always called
    typeof children === 'function' ? children(props) : !Route_isEmptyChildren(children) ? preact_compat_es.Children.only(children) : null : null;
  };
...
var Switch_Switch = function (_React$Component) {
  ...
  Switch.prototype.render = function render() {
    ...
    preact_compat_es.Children.forEach(children, function (element) {
      if (!preact_compat_es.isValidElement(element)) return;
...
var withRouter_withRouter = function withRouter(Component) {
  var C = function C(props) {
    ...
    return preact_compat_es.createElement(es_Route, { render: function render(routeComponentProps) {
        return preact_compat_es.createElement(Component, withRouter__extends({}, remainingProps, routeComponentProps, { ref: wrappedComponentRef }));
      } });
  };
...
function Link__objectWithoutProperties(obj, keys) {
  var target = {};for (var i in obj) {
    if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];
  }return target;
}
...
var Link_Link = function (_React$Component) {
  ...
  Link.prototype.render = function render() {
    var _props = this.props,
        ...
        props = Link__objectWithoutProperties(_props, ['replace', 'to', 'innerRef']); // eslint-disable-line no-unused-vars
...
var header_Header = function Header() {
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				es_Link,
				{ 'class': header_style_default.a.title, to: '/' },
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					es_Link,
					{ to: '#', 'class': header_style_default.a.menu_icon },
					header__ref
				),
				Object(preact_min["h"])(
					'div',
					...
					Object(preact_min["h"])(
						es_Link,
						{ to: '/about', 'class': header_style_default.a.page_link },
						'About'
					)
				)
			)
	...
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					'a',
					{ href: 'mailto:' + config_default.a.email },
					...
					config_default.a.articles.map(function (article) {
						return Object(preact_min["h"])(
							...
							Object(preact_min["h"])(
								...
								Object(preact_min["h"])(
									es_Link,
									{ 'class': 'post-link', to: '/article/' + article.name },
									article.name
								)
							)
						);
...
var app__ref2 = Object(preact_min["h"])(
	...
	Object(preact_min["h"])(
		'div',
		null,
		Object(preact_min["h"])(header, null),
		Object(preact_min["h"])(react_router_dom_es_Route, { exact: true, path: '/', component: app_Home }),
		Object(preact_min["h"])(react_router_dom_es_Route, { path: '/about', component: About }),
		Object(preact_min["h"])(react_router_dom_es_Route, { path: '/article/:name', component: article_Article }),
...
module.exports = {"title":"YongchaoLi","email":"linychuo@gmail.com","post_url":"https://raw.githubusercontent.com/linychuo/my-blog/master/_posts/","articles":[{"url":"java8-new-features-1.markdown","name":"Java8 new features [1]","created":"Apr 22, 2018"},{"url":"cefpython.markdown","name":"CEFPython","created":"Jan 8, 2018"},{"url":"local-fulltext-search-engine.markdown","name":"Local Fulltext Search Engine","created":"Jan 6, 2018"},{"url":"new-blog-using-preact.markdown","name":"New blog using preact","created":"Nov 5, 2017"},{"url":"preact.markdown","name":"Preact","created":"Oct 17, 2017"},{"url":"tmux.markdown","name":"Tmux","created":"Feb 23, 2016"},{"url":"frontend-development.markdown","name":"Frontend devleopment","created":"Dec 11, 2015"},{"url":"clojure-namesapces.markdown","name":"Clojure namespaces","created":"Oct 30, 2014"},{"url":"css-framework.markdown","name":"CSS framework","created":"Oct 30, 2014"},{"url":"stringbuilder-vs-stringbuffer-vs-stringwriter.markdown","name":"StringBuilder vs StringBuffer vs StringWriter","created":"Oct 30, 2014"},{"url":"decorator-of-python.markdown","name":"Decorator of python","created":"Oct 30, 2014"},{"url":"eval-on-javascript.markdown","name":"Eval usage","created":"Oct 30, 2014"},{"url":"function-invoking-rule-of-javascript.markdown","name":"Function invoking rule of javascript","created":"Oct 30, 2014"},{"url":"iterators-of-python.markdown","name":"Iterators of python","created":"Oct 30, 2014"},{"url":"list-process-of-python.markdown","name":"List process in python","created":"Oct 30, 2014"},{"url":"pre-search-of-regular-expression.markdown","name":"Pre-Search on regular expression","created":"Oct 30, 2014"},{"url":"three-things-you-should-never-put-in-your-database.markdown","name":"Three things you should never put in your database","created":"Oct 30, 2014"}],"socialSites":[{"name":"github","url":"https://github.com/linychuo","userName":"linychuo","icon":"M7.999,0.431c-4.285,0-7.76,3.474-7.76,7.761 c0,3.428,2.223,6.337,5.307,7.363c0.388,0.071,0.53-0.168,0.53-0.374c0-0.184-0.007-0.672-0.01-1.32 c-2.159,0.469-2.614-1.04-2.614-1.04c-0.353-0.896-0.862-1.135-0.862-1.135c-0.705-0.481,0.053-0.472,0.053-0.472 c0.779,0.055,1.189,0.8,1.189,0.8c0.692,1.186,1.816,0.843,2.258,0.645c0.071-0.502,0.271-0.843,0.493-1.037 C4.86,11.425,3.049,10.76,3.049,7.786c0-0.847,0.302-1.54,0.799-2.082C3.768,5.507,3.501,4.718,3.924,3.65 c0,0,0.652-0.209,2.134,0.796C6.677,4.273,7.34,4.187,8,4.184c0.659,0.003,1.323,0.089,1.943,0.261 c1.482-1.004,2.132-0.796,2.132-0.796c0.423,1.068,0.157,1.857,0.077,2.054c0.497,0.542,0.798,1.235,0.798,2.082 c0,2.981-1.814,3.637-3.543,3.829c0.279,0.24,0.527,0.713,0.527,1.437c0,1.037-0.01,1.874-0.01,2.129 c0,0.208,0.14,0.449,0.534,0.373c3.081-1.028,5.302-3.935,5.302-7.362C15.76,3.906,12.285,0.431,7.999,0.431z"},{"name":"twitter","url":"https://twitter.com/linychuo","userName":"linychuo","icon":"M15.969,3.058c-0.586,0.26-1.217,0.436-1.878,0.515c0.675-0.405,1.194-1.045,1.438-1.809 c-0.632,0.375-1.332,0.647-2.076,0.793c-0.596-0.636-1.446-1.033-2.387-1.033c-1.806,0-3.27,1.464-3.27,3.27 c0,0.256,0.029,0.506,0.085,0.745C5.163,5.404,2.753,4.102,1.14,2.124C0.859,2.607,0.698,3.168,0.698,3.767 c0,1.134,0.577,2.135,1.455,2.722C1.616,6.472,1.112,6.325,0.671,6.08c0,0.014,0,0.027,0,0.041c0,1.584,1.127,2.906,2.623,3.206 C3.02,9.402,2.731,9.442,2.433,9.442c-0.211,0-0.416-0.021-0.615-0.059c0.416,1.299,1.624,2.245,3.055,2.271 c-1.119,0.877-2.529,1.4-4.061,1.4c-0.264,0-0.524-0.015-0.78-0.046c1.447,0.928,3.166,1.469,5.013,1.469 c6.015,0,9.304-4.983,9.304-9.304c0-0.142-0.003-0.283-0.009-0.423C14.976,4.29,15.531,3.714,15.969,3.058z"}]}
...
module.exports = {"footer":"footer__14P9B","footer_heading":"footer_heading__31NB_","contact_list":"contact_list__2ve_I","social_media_list":"social_media_list__1nGQf","footer_col_wrapper":"footer_col_wrapper__3TXGl","footer_col":"footer_col__1_ZsD","footer_col_1":"footer_col_1__q5S5b","footer_col_2":"footer_col_2__3NUJC","footer_col_3":"footer_col_3__3FGUU","icon":"icon__2Bh2R"};
...
// removed by extract-text-webpack-plugin
module.exports = {"header":"header__3QGkI","title":"title__fBWIE","nav":"nav__2o4Om","menu_icon":"menu_icon__LR94X","page_link":"page_link__cIIkD","site-nav":"site-nav__aUSaz","trigger":"trigger__24ieQ"};
